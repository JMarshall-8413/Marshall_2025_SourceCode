...
files in "SourceCode2_JaccardAnalysis" are for detecting signal peaks, "forward smoothing" and performing the Jaccard correlation analysis described in the paper
